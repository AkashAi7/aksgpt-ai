...
import (
	...
	schemav1 "buf.build/gen/go/aksgpt-ai/aksgpt/protocolbuffers/go/schema/v1"
	"context"
	"fmt"
...
func (cli *Client) Run() (common.Result, error) {
	...
	if res.Result != nil {
		...
		// We should refactor this, because Error and Failure do not map 1:1 from aksgpt/schema
