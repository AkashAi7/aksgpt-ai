# Copyright 2023 Akssgpt AI. All rights reserved.
...
#
ROOT_PACKAGE=github.com/aksgpt-ai/aksgpt
...
IMG ?= ghcr.io/aksgpt-ai/aksgpt:latest

BUILDFILE = "./main.go"
BUILDAPP = "$(OUTPUT_DIR)/aksgpt"
...
## deploy: Deploy aksgpt
.PHONY: deploy
deploy: helm
	@echo "===========> Deploying aksgpt"
	$(HELM) install aksgpt charts/aksgpt -n aksgpt --create-namespace

## update: Update aksgpt
.PHONY: update
update: helm
	@echo "===========> Updating aksgpt"
	$(HELM) upgrade aksgpt charts/aksgpt -n aksgpt

## undeploy: Undeploy aksgpt
.PHONY: undeploy
undeploy: helm
	@echo "===========> Undeploying aksgpt"
	$(HELM) uninstall aksgpt -n aksgpt
...
#	@addlicense -y $(shell date +"%Y") -v -c "Akssgpt AI." -f $(LICENSE_TEMPLATE) $(CODE_DIRS)
